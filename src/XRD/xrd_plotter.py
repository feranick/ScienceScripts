...
class XRDPlotterGUI:
    ...
    # Hovering a reflection reports which references are still consistent with
    ...
    def peakid_ensure_index(self):
        ...
        if positions > PEAKID_MAX_POSITIONS:
            ...
            self.peakid_note.set("Too many reference reflections to index "
